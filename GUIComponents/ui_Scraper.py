...
class Ui_HSIWebScraper(object):
    def setupUi(self, HSIWebScraper):
        ...
        self.setList.setGeometry(QtCore.QRect(600, 191, 256, 181))
        ...
        self.newSetTextBox.setGeometry(QtCore.QRect(600, 150, 131, 31))
        ...
        self.keywordList.setGeometry(QtCore.QRect(110, 171, 256, 201))
        ...
        self.newSetLabel.setGeometry(QtCore.QRect(600, 130, 141, 16))
        self.newSetLabel.setObjectName("newSetLabel")
        self.addSetButton = QtWidgets.QPushButton(parent=self.EditKeywords)
        self.addSetButton.setGeometry(QtCore.QRect(750, 150, 101, 32))
        ...
        self.newSetLabel_2.setGeometry(QtCore.QRect(600, 110, 241, 16))
    ...
    def retranslateUi(self, HSIWebScraper):
        ...
        self.newSetTextBox.setPlaceholderText(_translate("HSIWebScraper", " Type set name."))
